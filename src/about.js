...
export default function About(props) {
    return(
    <>
        <div className={`accordion bg-${props.mode} text-${props.mode === "dark" ? "light" : "dark"}`} id="accordionExample">
            <div className={`accordion-item bg-${props.mode} text-${props.mode === "dark" ? "light" : "dark"}`}>
                <h2 className="accordion-header">
                    <button className={`accordion-button  bg-${props.mode} text-${props.mode === "dark" ? "light" : "dark"}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        Accordion Item #1
                    </button>
                </h2>
